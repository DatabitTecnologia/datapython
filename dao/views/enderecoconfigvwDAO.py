...
class EnderecoConfigVWDAO(dao.Dao):

    def __init__(self):
        super().__init__("VW00014", "Configuração", "a",
                         "Configurações de endereço (VIEW)", "N", "N", "N", "TB00013")

    def listEnderecoConfigVW(self, params):
        """
    ...
    def fieldsEnderecoConfigVW(self, params):
        """
    ...
    def dictEnderecoConfigVW(self, params):
        """
