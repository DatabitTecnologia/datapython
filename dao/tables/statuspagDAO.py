...
class StatuspagDAO(dao.Dao):

    def __init__(self):
        super().__init__("TB01102", "Status", "o", "Status de Pagamento", "S", "S",
                         "S", "TB01102")

    def listStatuspag(self, params):
        """
    ...
    def fieldsStatuspag(self, params):
        """
