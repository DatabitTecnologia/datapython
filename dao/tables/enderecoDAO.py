...
class EnderecoDAO(dao.Dao):

    def __init__(self):
        super().__init__("TB00012", "Endereço", "o", "Endereço", "N", "N", "N", "TB00012")

    def listEndereco(self, params):
        """
    ...
    def fieldsEndereco(self, params):
        """
