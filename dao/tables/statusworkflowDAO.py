...
class StatusWorkflowDAO(dao.Dao):

    def __init__(self):
        super().__init__("TB01057", "Status", "o", "Configurações de Status.", "N", "N", "N", "TB01057")

    def listStatusWorkflow(self, params):
        """
    ...
    def fieldsStatusWorkflow(self, params):
        """
    ...
    def dictStatusWorkflow(self, params):
        """
    ...
    def findStatusWorkflow(self, params):
        """
    ...
    def insStatusWorkflow(self, params):
        """
    ...
    def updStatusWorkflow(self, params):
        """
    ...
    def delStatusWorkflow(self, params):
        """
