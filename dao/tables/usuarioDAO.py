...
class UsuarioDAO(dao.Dao):

    def __init__(self):
	    super().__init__( "TB00035", "Usuário", "o" , "Usuarios", "S", "S", "S", "VW00008")
		
		
    def listUsuario(self, params):
        """
