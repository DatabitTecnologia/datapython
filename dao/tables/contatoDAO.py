...
class ContatoDAO(dao.Dao):

    def __init__(self):
        super().__init__("TB01128", "Contato", "o", "DataClient - Definição de Contatos", "S", "N", "S", "VW01125")

    def listContato(self, params):
        """
