...
class GrupoDAO(dao.Dao):

    def __init__(self):
        super().__init__( "TB01002", "Grupo", "o", "Grupo de Produtos", "S", "S", "S", "TB01002")

    def listGrupo(self, params):
        """
