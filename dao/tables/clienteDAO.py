...
class ClienteDAO(dao.Dao):

    def __init__(self):
        super().__init__("TB01008", "Cliente", "o", "Cliente", "S", "S", "S", "VW01007")

    def listCliente(self, params):
        """
