...
class StatusoutDAO(dao.Dao):

    def __init__(self):
        super().__init__("TB01073", "Status", "o", "Status de Outsourcing", "S", "S",
                         "S", "TB01073")

    def listStatusout(self, params):
        """
    ...
    def fieldsStatusout(self, params):
        """
