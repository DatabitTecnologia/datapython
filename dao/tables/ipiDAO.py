...
class IpiDAO(dao.Dao):

    def __init__(self):
        super().__init__( "TB01054", "CST IPI", "o", "Cadastro de Situação Tributária de IPI", "N",
                         "S", "S", "TB01054")

    def listIpi(self, params):
        """
