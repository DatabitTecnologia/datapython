...
class PlanoDAO(dao.Dao):

    def __init__(self):
        super().__init__( "TB04006", "Plano de Conta", "o", "Plano de Contas", "N", "N", "S", "VW04003")

    def listPlano(self, params):
        """
