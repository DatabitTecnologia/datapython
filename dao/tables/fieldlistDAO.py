...
class FieldlistDAO(dao.Dao):

    def __init__(self):
        super().__init__( "TB00101", "Campo", "o",
                         "Campos que irão sair na listagem (DataClassic WEB)", "N", "N", "S", "TB00101")

    def listFieldlist(self, params):
        """
    ...
    def fieldsFieldlist(self, params):
        """
