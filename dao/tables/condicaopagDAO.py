...
class CondicaopagDAO(dao.Dao):

    def __init__(self):
        super().__init__("TB01012", "Condição", "a", "Condição de pagamento", "S",
                         "S", "S", "VW01050")

    def listCondicaopag(self, params):
        """
    ...
    def fieldsCondicaopag(self, params):
        """
    ...
    def dictCondicaopag(self, params):
        """
    ...
    def findCondicaopag(self, params):
        """
    ...
    def insCondicaopag(self, params):
        """
    ...
    def updCondicaopag(self, params):
        """
    ...
    def delCondicaopag(self, params):
        """
