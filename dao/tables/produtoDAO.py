...
class ProdutoDAO(dao.Dao):

    def __init__(self):
        super().__init__("TB01010", "Produto", "o", "Cadastro de Produtos", "S", "S", "S",
                         "VW01022")

    def listProduto(self, params):
        """
