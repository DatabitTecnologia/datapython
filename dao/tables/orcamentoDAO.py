...
class OrcamentoDAO(dao.Dao):

    def __init__(self):
        super().__init__("TB02018", "Orçamento", "o", "Controle de Orçamento", "S", "N",
                         "S", "VW02017")

    def listOrcamento(self, params):
        """
    ...
    def fieldsOrcamento(self, params):
        """
