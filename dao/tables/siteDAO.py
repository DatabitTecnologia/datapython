...
class SiteDAO(dao.Dao):

    def __init__(self):
        super().__init__( "TB02176", "Site", "o", "NDDigital - Cadastro de Site", "S", "S", "S",
                         "VW02233")
